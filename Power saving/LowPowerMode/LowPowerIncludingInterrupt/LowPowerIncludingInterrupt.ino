#include "LowPower.h"
//#define BUTTON_PIN 3
//code above, example to define your pin to recieve interrupt from
...
void setup() {
  ...
  //Code above, example to setup your interrupt pin as an input pin

  //attachInterrupt(digitalPinToInterrupt(BUTTON_PIN), blinkLed, RISING);
  //Code above, 1st parameter = pin interrupt, 2nd parameter = function, 3rd parameter = types of interrupt
}
